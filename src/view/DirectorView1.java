...
public class DirectorView1 {
	...
	//	fileMenu.add(newMenuItem);
		...
		Action budgetAction = new AbstractAction("Budget", newIcon) {
			@Override
			public void actionPerformed(ActionEvent e) {
		...
		JMenuItem budgetActionTest = new JMenuItem(budgetAction);
		budgetMenu.add(budgetActionTest);
	...
	public static  ImageIcon createImageIcon(String path,
			String description) {
		java.net.URL imgURL = DirectorView1.class.getResource(path);
		if (imgURL != null) {
	...
	public void openProjectPanel()
	{
		...
		directorView1.getContentPane().add(panelChef1);
	...
	private void hidePanels(){
		...
		if ( panelThatWillChange1 != null) directorView1.getContentPane().remove(panelThatWillChange1);

		if ( panelThatWillChange2 != null) directorView1.getContentPane().remove(panelThatWillChange2);
		if ( panelThatWillChange3 != null) directorView1.getContentPane().remove(panelThatWillChange3);
		if ( panelThatWillChange4 != null) directorView1.getContentPane().remove(panelThatWillChange4);
		if ( panelThatWillChange5 != null) directorView1.getContentPane().remove(panelThatWillChange5);
		if ( panelThatWillChange6 != null) directorView1.getContentPane().remove(panelThatWillChange6);
		if ( panelThatWillChange7 != null) directorView1.getContentPane().remove(panelThatWillChange7);
		directorView1.revalidate();
		directorView1.repaint();
	}
	...
	public void openTaskPanel()
	{
		...
		directorView1.getContentPane().add(panelForTasks);
	...
	public void addBudget()
	{
		...
		JTextField budjetF = new JTextField();
		...
		btnConfirmer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dbq.addBudgetToDB(Sproject.index, Integer.parseInt(budjetF.getText()));
				frame.dispose();
			}
		});
